    ...
    (function (global2, factory) {
      typeof exports2 === 'object' && typeof module2 !== 'undefined'
        ...
        : typeof define === 'function' && define.amd
          ...
          : ((global2 = typeof globalThis !== 'undefined' ? globalThis : global2 || self), factory((global2.WebStreamsPolyfill = {})));
      ...
      function convertTransformer(original, context) {
        ...
        return {
          ...
          transform:
            transform === void 0 ? void 0 : convertTransformerTransformCallback(transform, original, `${context} has member 'transform' that`),
          writableType
        };
      }
  ...
  'node_modules/formdata-polyfill/esm.min.js'() {
    ...
    f = (a, b, c) => (
      ...
      /^(Blob|File)$/.test(b && b[t])
        ? [((c = c !== void 0 ? c + '' : b[t] == 'File' ? b.name : 'blob'), a), b.name !== c || b[t] == 'blob' ? new file_default([b], c, b) : b]
        : [a, b + '']
    );
...
var init_from = __esm({
  'node_modules/fetch-blob/from.js'() {
    ...
    fromBlob = (stat2, path, type = '') =>
      new fetch_blob_default(
        [
          new BlobDataItem({
            path,
            size: stat2.size,
    ...
    fromFile = (stat2, path, type = '') =>
      new file_default(
        ...
        { type, lastModified: stat2.mtimeMs }
      );
  ...
  try {
    ...
    const error_ =
      error instanceof FetchBaseError
        ? error
        : new FetchError(`Invalid response body while trying to fetch ${data.url}: ${error.message}`, 'system', error);
    throw error_;
  }
    ...
    const onData = buf => {
      ...
      if (!properLastChunkReceived && previousChunk) {
        properLastChunkReceived =
          import_node_buffer2.Buffer.compare(previousChunk.slice(-3), LAST_CHUNK.slice(0, 3)) === 0 &&
          import_node_buffer2.Buffer.compare(buf.slice(-2), LAST_CHUNK.slice(3)) === 0;
      }
      previousChunk = buf;
    };
...
var { fetch: fetch2 } = (init_src(), __toCommonJS(src_exports));
